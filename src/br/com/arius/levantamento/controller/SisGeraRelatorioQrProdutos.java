...
public class SisGeraRelatorioQrProdutos {
	...
	// String p_IdUsuario,
	public void geraRelatorioQrProdutos(Integer p_IdEmpresa, String pIdProduto, String pIdFornecedor,
			String p_dataIniVenda, String p_dataFinVenda, String pDataIncialCompra, String pDataFinalCompra)
			throws Exception {

		try {
			String jrxml = getPathRelatorios() + "layouts/creLevantamentoprodutos" + ".jrxml";
			String pdf = getPathRelatorios() + "gerados/creLevantamentoprodutos" + ".pdf";
			String jasper = JasperCompileManager.compileReportToFile(jrxml);

			System.out.println("### " + pdf);
			System.out.println("Relatório compilado com êxito.");

			HashMap paramsRel = new HashMap();

			paramsRel.put("pIdEmpresa", p_IdEmpresa);
			paramsRel.put("pIdProduto", pIdProduto);
...
//			Runtime.getRuntime().exec("C:\\Arius\\AriusEtiqueta\\relatorios\\gerados\\crelevantamento.pdf");
			...
			String comando = "C:\\Arius\\AriusLevantamento\\relatorios\\gerados\\creLevantamentoprodutos.pdf";
			try {
