...
public class SisGeraRelatorioQrPesqc {
	...
	// String p_IdUsuario,
	public void geraRelatorioQrPesqc(Integer p_IdEmpresa, String pIdFornecedor, String p_dataIniVenda,
			String p_dataFinVenda, String pDataIncialCompra, String pDataFinalCompra) throws Exception {

		try {
			String jrxml = getPathRelatorios() + "layouts/crelevantamento" + ".jrxml";
			String pdf = getPathRelatorios() + "gerados/crelevantamento" + ".pdf";
			...
			String comando = "C:\\Arius\\AriusLevantamento\\relatorios\\gerados\\crelevantamento.pdf";
			try {
